...
# Define current location of this file and modify it to meet download location
...
# Check if metafile is present
Data = []
try:
	Files = os.listdir(CompletePath+'/Analysis_Files/')
	for aItem in Files:
		SP1 = aItem.split('.')
		if SP1[0]=='LANDSAT_8_C1':
			Data.append(aItem)
except:
	pass
...
if len(Data)==0:
	...
	# open(CompletePath+'/Analysis_Files/LANDSAT_8_C1.csv.gz', 'wb').write(myfile.content)
	print 'Unzipping File...'
	with gzip.open(CompletePath+'/Analysis_Files/LANDSAT_8_C1.csv.gz', 'rb') as f_in:
		with open(CompletePath+'/Analysis_Files/LANDSAT_8_C1.csv', 'wb') as f_out:
...
# Open the file
RawData = []
with open(CompletePath+'/Analysis_Files/Analysis_Meta.txt', 'r') as File:
	for aRow in File:
		RawData.append(aRow)
...
# Automatically update to current year

# CY = int(datetime.date.today().year)
# TO test this, CY will be set to 2019
# CY = 2019
# Years = []
# # Range requires +1 at end
# for x in range(2014, CY+1):
# 	Years.append(x)
Years = [2014, 2015, 2016, 2017, 2018, 2019, 2020]
OutputPathMeta = CompletePath+'/Analysis_Files/'
...
# for df in pd.read_csv(OutputPathMeta+'LANDSAT_8_C1.csv', chunksize=100000):
# 	ps = pd.DataFrame(df)
...
# 			if PRextract==aCode:
# 				# Filter by year in list, convert to integer to match year format
# 				Yearextract = int(Sp1[3][0:4])
# 				# print Yearextract
# 				# sys.exit()
# 				for aYear in Years:
...
# df.to_csv(OutputPathMeta+'BaseImages.csv')
...
with open(OutputPathMeta+'BaseImages.csv', 'r') as File:
	for aRow in File:
		RawData.append(aRow)
		# sys.exit()
File.close()
...
# request.
Remove = ["LC08_L1TP_034027_20160605_20170223_01_T1", 
...
"LC08_L1TP_030030_20160609_20170223_01_T1",
"LC08_L1TP_031029_20160531_20170223_01_T1",
"LC08_L1TP_031030_20160531_20170223_01_T1"]

# Remove = []
 
FilteredImages = list(set(AllImages)-set(Remove))
